...
/**
 * Created by zhou.mi on 2018/3/2.
 */
...
public class WiFiPos {
    ...
    //private BufferedWriter socketOut = null;
     ...
     * @throws IOException
     */
    public WiFiPos(String ip, int port, String encoding) throws IOException {
        sock = new Socket(ip, port);
        socketOut = new DataOutputStream(sock.getOutputStream());
        //socketOut = new BufferedWriter(new OutputStreamWriter(sock.getOutputStream(),"UTF-8"));
    ...
    //蓝牙初始化
    public WiFiPos(OutputStream outputStream, String encoding) throws IOException {
