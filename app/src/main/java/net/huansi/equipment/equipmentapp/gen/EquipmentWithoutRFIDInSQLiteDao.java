...
/** 
 * DAO for table "EQUIPMENT_WITHOUT_RFIDIN_SQLITE".
*/
public class EquipmentWithoutRFIDInSQLiteDao extends AbstractDao<EquipmentWithoutRFIDInSQLite, Long> {

    public static final String TABLENAME = "EQUIPMENT_WITHOUT_RFIDIN_SQLITE";

    /**
     * Properties of entity EquipmentWithoutRFIDInSQLite.<br/>
    ...
    public static class Properties {
        ...
        public final static Property IsBindRFID = new Property(12, int.class, "isBindRFID", false, "IS_BIND_RFID");
        public final static Property BUsable = new Property(13, int.class, "bUsable", false, "B_USABLE");
    }


    public EquipmentWithoutRFIDInSQLiteDao(DaoConfig config) {
        super(config);
    }
    
    public EquipmentWithoutRFIDInSQLiteDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"EQUIPMENT_WITHOUT_RFIDIN_SQLITE\" (" + //
                ...
                "\"MODEL\" TEXT," + // 10: model
                "\"RFID\" TEXT," + // 11: RFID
                "\"IS_BIND_RFID\" INTEGER NOT NULL ," + // 12: isBindRFID
                "\"B_USABLE\" INTEGER NOT NULL );"); // 13: bUsable
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"EQUIPMENT_WITHOUT_RFIDIN_SQLITE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, EquipmentWithoutRFIDInSQLite entity) {
        stmt.clearBindings();
        ...
        stmt.bindLong(13, entity.getIsBindRFID());
        stmt.bindLong(14, entity.getBUsable());
    }

    @Override
    protected final void bindValues(SQLiteStatement stmt, EquipmentWithoutRFIDInSQLite entity) {
        stmt.clearBindings();
    ...
    @Override
    public EquipmentWithoutRFIDInSQLite readEntity(Cursor cursor, int offset) {
        EquipmentWithoutRFIDInSQLite entity = new EquipmentWithoutRFIDInSQLite( //
            ...
            cursor.getInt(offset + 12), // isBindRFID
            cursor.getInt(offset + 13) // bUsable
        );
        return entity;
    }
     
    @Override
    public void readEntity(Cursor cursor, EquipmentWithoutRFIDInSQLite entity, int offset) {
        ...
        entity.setIsBindRFID(cursor.getInt(offset + 12));
        entity.setBUsable(cursor.getInt(offset + 13));
     }
    
    @Override
    protected final Long updateKeyAfterInsert(EquipmentWithoutRFIDInSQLite entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(EquipmentWithoutRFIDInSQLite entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(EquipmentWithoutRFIDInSQLite entity) {
