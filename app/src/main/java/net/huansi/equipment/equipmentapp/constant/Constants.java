package net.huansi.equipment.equipmentapp.constant;//package net.huansi.equipment.equipmentapp.constant;
...
public class Constants {
    public  static List<String> videoUrl=new ArrayList<>();


//                        {
//                            "http://10.17.111.23:8064/mp4/bar.mp4",
