 ...
 */
public class HsArrayAdapter<T> extends BaseAdapter implements Filterable, ThemedSpinnerAdapter {
    /**
     ...
     *                 instantiating views.
     */
    public HsArrayAdapter(@NonNull Context context, @LayoutRes int resource) {
     ...
     */
    public HsArrayAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull T[] objects) {
     ...
     */
    public static @NonNull HsArrayAdapter<CharSequence> createFromResource(@NonNull Context context,
                                                                           @ArrayRes int textArrayResId, @LayoutRes int textViewResId) {
        final CharSequence[] strings = context.getResources().getTextArray(textArrayResId);
        return new HsArrayAdapter(context, textViewResId, strings);
    }
