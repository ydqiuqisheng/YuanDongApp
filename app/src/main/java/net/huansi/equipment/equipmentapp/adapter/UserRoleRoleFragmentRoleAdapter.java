...
// */
//public class UserRoleRoleFragmentRoleAdapter extends HsBaseAdapter<EPRole> {
//
//    public UserRoleRoleFragmentRoleAdapter(List<EPRole> list, Context context) {
//        super(list, context);
//    }
//
//    @Override
...
//        EPRole epRole=mList.get(position);
//        tvUserRoleUserFragmentUserItem.setText(epRole.SROLENAME);
